...
OUT_TEX     = os.path.join(SCRATCHPAD, 'book_en.tex')
OUT_PDF_SRC = os.path.join(SCRATCHPAD, 'book_en.pdf')
OUT_PDF_DST = '/home/user/tts-docs/peace-we-can-avoid-it.pdf'

# Part-title pages inserted before the file bearing this number
PART_PAGES = {
...
\pagestyle{fancy}
\fancyhf{}
\rhead{\color{ardoise}\small PEACE, WE CAN AVOID IT}
...
\vspace*{4cm}
\begin{center}
{\Huge\bfseries\MakeUppercase{Peace, we can avoid it}}\\[1cm]
{\large\color{gold} Investigation into the birth of the Alliance of Sahel States}\\[2cm]
{\Large BEN--H2O}\\[0.5cm]
{\color{gold} --- 2026 ---}
\end{center}
\vfill
\begin{center}
{\small\color{gold} \copyright{} 2026 BEN--H2O --- All rights reserved.}
\end{center}
\end{titlepage}
\pagecolor{white}
\color{black}
