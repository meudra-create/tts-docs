...
OUT_TEX     = os.path.join(SCRATCHPAD, 'book_facile.tex')
OUT_PDF_SRC = os.path.join(SCRATCHPAD, 'book_facile.pdf')
OUT_PDF_DST = '/home/user/tts-docs/la-paix-on-peut-leviter-facile.pdf'
...
\pagestyle{fancy}
\fancyhf{}
\rhead{\color{ardoise}\small LA PAIX, ON PEUT L'ÉVITER --- FACILE}
...
\vspace*{4cm}
\begin{center}
{\Huge\bfseries\MakeUppercase{La paix, on peut l'éviter}}\\[0.5cm]
{\Large\color{gold} Version en fran\c{c}ais facile}\\[1cm]
