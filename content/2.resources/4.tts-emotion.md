...
This is the text-to-speech endpoint with emotion layered on top. Pick a vibe, add a custom prompt if you want, and the output comes back sounding happy, calm, excited, whatever fits the moment.

## Emotion To Speech
`POST https://api.ttsopenai.com/uapi/v1/text-to-speech-advanced`

Converts text into speech with an emotional tone. On top of voice, speed, and model, you also set a vibe and, optionally, a custom prompt to steer the delivery.
